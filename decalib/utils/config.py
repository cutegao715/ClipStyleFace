...
cfg.model.dense_topology_path = os.path.join(cfg.deca_dir, 'data', 'head_template_dense.obj')
...
# ---------------------------------------------------------------------------- #
cfg.dataset = CN()
cfg.dataset.training_data = ['celebahq']
# cfg.dataset.training_data = ['ethnicity']
cfg.dataset.eval_data = ['now']
...
# Default paths for Datasets to be updated here..
cfg.dataset.now_dataset_path = "Now_Dataset"
cfg.dataset.celebA_path = "D:/dataset/face/2d/CelebAMask-HQ/"
cfg.dataset.stylegan_path = "/media/exx/8TB1/ayush/generated_images"
cfg.dataset.load_arcface_inp = False
