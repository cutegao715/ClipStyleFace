...
class DECA(nn.Module):
    ...
    def decode(self, codedict, name, rendering=True, iddict=None, vis_lmk=True, return_vis=True, use_detail=True,
        ...
        pose_params[:, :3] = torch.tensor([0.0, 0.0, 0.0]).to(self.device).repeat(batch_size, 1)
        ...
        if return_vis:
            ...
            if self.create_sh_video:
                ...
                _uv_texture_gt = torchvision.transforms.Resize(512)(uv_texture_gt)
                ops = self.render(verts, trans_verts, _uv_texture_gt, h=512, w=512, background=white_bg)
            ...
            if self.cfg.model.use_tex:
                ...
                if self.cfg.model.extract_tex:
                    ...
                    uv_texture_gt = uv_texture_gt[:, :3, :, :] * self.uv_face_eye_mask + (
                                uv_texture[:, :3, :, :] * (1 - self.uv_face_eye_mask))
    ...
    def save_obj(self, filename, opdict, codedict):
        ...
        dense_vertices, dense_colors, dense_faces, dense_uv_coords = util.upsample_mesh(vertices, normals, faces,
    ...
    def decode_tex(self, codedict, rendering=True, iddict=None, vis_lmk=True, return_vis=True, use_detail=True,
        ...
        return uv_texture_gt, verts, self.uv_face_eye_mask, uv_gt
