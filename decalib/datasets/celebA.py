...
class CelebAHQDataset(Dataset):
    def __init__(self, image_size=224, scale=1.4, trans_scale=0, isEval=False,
                 data_dir="D:/dataset/face/2d/CelebAMask-HQ/", use_mica=False):
        '''
        # 53877 faces
        K must be less than 6
        '''
        self.image_size = image_size
        self.imagefolder = f'{data_dir}/CelebA-HQ-img'
        self.kptfolder = f'{data_dir}/5_landmarks224x224'
        self.segfolder = f'{data_dir}/parsing_masks'
