...
albedo_args = uda_models.make_dataclass_from_args()
args.add_to_registry("albedo_args")(albedo_args)
...
def load_config():
    ...
    albedo_args = get_generator_args(
        config_file.training.generator,
        base_gen_args_config.albedo_args[config_file.training.generator],
        config_file.albedo_args,
    )

    gen_args = OmegaConf.create({
        'generator_args': generator_args,
        'albedo_args': albedo_args,
    })
