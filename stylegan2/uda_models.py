...
from stylegan2.offset_model import (
    OffsetsGenerator,
    ModModulatedConv2d,
    DecModulatedConv2d,
...
class OffsetsTunningGenerator(torch.nn.Module):
    def __init__(self, img_size=1024, latent_size=512, map_layers=8,
                 channel_multiplier=2, device='cuda:0', checkpoint_path='./weights/stylegan2/training_logs/checkpoint/albedo_GAN.pt'):
        super().__init__()
        ...
        self.generator = OffsetsGenerator(1024, 512, 8, channel_multiplier=2)
        self.generator.to(device)
        ckpt_path = './weights/stylegan2/training_logs/checkpoint/stylegan2_ffhq.pt'
